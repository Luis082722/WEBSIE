		...
		<div class="container register-form">
			...
			<?php
				...
				if (isset($_POST["submit"])) {
					...
					$sqlCheckEmail = "SELECT * FROM user_details_tbl WHERE email = ?";
					...
					if (count($errors) > 0) {
						...
						$sqlInsertInfo = "INSERT INTO user_details_tbl (firstname, lastname, blk_lot, street, phase_subdivision, barangay, city_municipality, province, country, contact_no, email, password) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
